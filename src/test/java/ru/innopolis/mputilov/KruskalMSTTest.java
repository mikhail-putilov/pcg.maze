...
//                graph.addEdge(new Edge(getAbsoluteIndex(i + 1, j), getAbsoluteIndex(i, j), w1));

                graph.addEdge(new Edge(getAbsoluteIndex(i, j), getAbsoluteIndex(i, j + 1), w2));
//                graph.addEdge(new Edge(getAbsoluteIndex(i, j + 1), getAbsoluteIndex(i, j), w2));
            }
        }
        for (int i = 0; i < SIZE-1; i++) {
            double w1 = random.nextDouble();
...
//            Edge e2 = new Edge(getAbsoluteIndex(i + 1, SIZE - 1), getAbsoluteIndex(i, SIZE - 1), w1);
            Edge e3 = new Edge(getAbsoluteIndex(SIZE - 1, i), getAbsoluteIndex(SIZE - 1, i + 1), w2);
//            Edge e4 = new Edge(getAbsoluteIndex(SIZE - 1, i + 1), getAbsoluteIndex(SIZE - 1, i), w2);
            graph.addEdge(e1);
//            graph.addEdge(e2);
            graph.addEdge(e3);
//            graph.addEdge(e4);
